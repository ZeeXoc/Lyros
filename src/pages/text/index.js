            ...
            <div className="col s12 m12">
                <div className="row">
                    <div className="input-field col s12 m4">
                        <Cascader id="select" options={options} />
                        <Button type="default" className="btn" onClick={this.handleStart.bind(this)}>开始</Button>
                        <Button type="default" className="btn" onClick={this.handleReset.bind(this)}>重置</Button>
                    </div>
